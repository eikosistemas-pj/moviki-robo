...
// PRECOS DE 16/09/2026 — trocados ANTES do primeiro cliente pagante real, que
// e a unica janela em que preco se corrige de graca. O TRIMESTRAL FOI
// APOSENTADO: tres periodos x tres planos eram nove combinacoes de checkout
// para um produto com zero cliente. Link antigo com ?periodo=trimestral cai no
// mensal pelo painel; se ainda assim chegar aqui, o criar-assinatura.js recusa
// com 400, que e o comportamento correto — nunca cobrar um valor que a tela
// nao mostrou.
const PLANOS = {
  pro: {
    mensal:     { value: 39.90,  cycle: 'MONTHLY',   dias: 31 },
    anual:      { value: 399.00, cycle: 'YEARLY',    dias: 366 },
  },
  premium: {
    mensal:     { value: 69.90,  cycle: 'MONTHLY',   dias: 31 },
    anual:      { value: 699.00, cycle: 'YEARLY',    dias: 366 },
  },
  // Enterprise: base cobre ate 3 pontos. So mensal por enquanto (o valor
  // publico e R$129,90/mes). Cada ponto ALEM de 3 e cobrado a parte, como uma
  // assinatura recorrente separada de PONTO_EXTRA (ver abaixo).
  enterprise: {
    mensal:     { value: 129.90, cycle: 'MONTHLY',   dias: 31 },
  },
};
